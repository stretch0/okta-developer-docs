...
> **Note:** If you are using PKCE, generating a URL like this yourself wont will skip the necessary steps to generate and store the PKCE as outlined [here](https://developer.okta.com/docs/guides/implement-grant-type/authcodepkce/main/#flow-specifics). It is recommended to use the [Okta SDK](https://github.com/okta/okta-auth-js#signinwithredirectoptions)
